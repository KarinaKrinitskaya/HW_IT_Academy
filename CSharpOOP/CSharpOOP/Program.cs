...
//Наследование - последний айфон, имеет кучу функций унаследованных от предыдущих моделей,старый корпус, экран, процессор, но у него есть новые свойства, модуль камеры пересобран и тд
...
//Полиморфизм - 1)Кошечка и собачка знают команду "Голос", но кошечка мяукает, а собачка гавкает на одну и ту же команду ("Голос") !
// 2)есть чувак, полный твой тезка и вы родились в один день, он грабит банк и оставляет свою подпись (ФИО), свидетельство о рождении и скрывается, но садят тебя, потому что это Хабаровск и конец квартала
